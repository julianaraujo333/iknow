<html>
  <head>
    <title>Scroll effects: Level up your CSS animation skills</title>
    <!-- The default layout, resets and and text styling -->
    <link href="stylesheets/main-scroll-animations.css" rel="stylesheet">
    <!-- Custom styling -->
  ...
  <body>
    ...
    <img src="images/pizza2.jpg" class="inline-photo show-on-scroll">
    ...
    <img src="images/pizza_spin.jpg" class="inline-photo show-on-scroll">
    ...
    <img src="images/pizza_oven.jpg" class="inline-photo show-on-scroll">
    ...
    <img src="images/pizza3.jpg" class="inline-photo show-on-scroll">
